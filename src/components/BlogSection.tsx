      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayedViajes.map((viaje, i) => (
            <article
              key={viaje.id}
              className="group bg-white/[0.02] border border-white/5 hover:border-gold/30 transition-all duration-500 flex flex-col h-full animate-fade-in"
            >
              {/* Imagen */}
              ...
              <div className="p-8 flex flex-col flex-grow space-y-4">
                ...
                <div className="pt-6 border-t border-white/5 flex justify-between items-center">
                  <div className="flex gap-4">
                    ...
                    {((viaje.galeriaCount !== undefined && viaje.galeriaCount > 0) || (viaje.galeria && viaje.galeria.length > 0)) && (
                      <Link 
